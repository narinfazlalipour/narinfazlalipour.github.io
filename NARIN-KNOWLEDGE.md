# Narin Fazlalipour — Canonical Knowledge Source

> **Purpose:** Single source of truth for Narin's professional identity. This document feeds the personal website, LinkedIn, resume, and any other public-facing materials. Update here first, propagate outward.

---

## Identity

- **Full Name:** Narin Fazlalipour
- **Email:** hello@narinfazlalipour.com
- **Domain:** narinfazlalipour.com
- **Instagram:** @nar_x90
...
1. **GCC Honors — Community Service Outreach** _(2 years)_
   ...
   - Pediatric charity fundraisers
   - Attended developmental faculty committees

2. **GCC Student Ambassador** _(6 months)_
   - Guided second-language learners and elderly students through college applications, FAFSA, academic schedules
   - Designed social media recruitment content

3. **GCC Activities Ambassador** _(1 semester)_
   - Represented ~1,100 students
   - Planned wellness conferences and networking events

### 2022 — Transition Year
4. **Caring Bear Dental — Dental Assistant** _(Mar 2022 – Sep 2022, 7 months)_
   - Clinical dental assisting experience

5. **UCSD STARS — Research Coordinator** _(Oct 2022 – Jun 2024, 20 months)_
   - Summer Training Academy for Research Success
   - Matched undergraduates with PhD faculty mentors
   - Managed program logistics, applications, orientations, seminar schedules
   - Ran social media channels

### 2023 — Research Deepens
6. **CNP Lab — Bench Research** _(Mar 2023 – Present, 480+ hours)_
   - CardioNeuroProtection Lab, UCSD Neuroscience Dept, PI: Hemal H. Patel, PhD
   - Wet lab: cell culture, Seahorse metabolic assays, ELISA, PCR, Western blotting
   - Neuroimaging analysis

7. **CNP Lab — Patient Sample Collection** _(Jul 2023 – Present, 320+ hours)_
   - 9-day meditation research retreats
   - Collected biological samples (plasma, saliva, cheek scrapes, urine) from participants with cancer, PTSD, ALS, MS
   - Human subjects research, informed consent, field adaptability

8. **Remote Healing — Healed by the Future** _(2023 – Present)_
   - Facilitated twice-weekly guided meditation and energy work sessions
   - Led 12-week group healing programs for autistic children
   - Adapted pacing, sensory triggers, and visual structures for neurodivergent needs

9. **TEDxUCSD 2023 — Student Speaker**
   - Talk title: "Ego" — recognizing ego and shifting its definition
...
13. **UCLA Health — Department Coordinator at Santa Monica Hospital & Clinical Volunteer** _(Nov 2025 – Present, 252+ Care Extender hours at UCLA Health)_
...
- **DOI:** [10.1038/s42003-025-09088-3](https://doi.org/10.1038/s42003-025-09088-3)
- **Authors:** Jinich-Diamant A, Garland E, Baumgartner N, Gonzalez N, Quazi G, Castejon J, Rosenberg JT, Klinger D, Baker SD, Griffith M, Licamele M, Chernov M, Amkie Stahl NE, **Fazlalipour N**, Devulapalli S, Christov-Moore L, Reggente N, Poirier MA, Moeller-Bertram T, Patel HH
- **Key findings:** 7-day retreat combining meditation + reconceptualization + open-label placebo produced: reduced DMN/salience network connectivity, enhanced neuroplasticity (neurite outgrowth), glycolytic metabolic shifts, endogenous opioid elevation, immune pathway modulation
...
These are the personal anchors displayed on the redesigned couch overview:

- 🧠 **Neuroscience** — studying the brain's capacity to change
- 💪 **Lagree** — discipline through movement
- ❤️ **Heart-centered medicine** — training presence as rigorously as clinical skill
- ✨ **Mind-body connection** — the seam where thought becomes biology

---

## Design Decisions for Public Materials

- **Tone:** Warm, rigorous, heart-centered — not clinical, not fluffy
- **Color:** Deep royal blue accent on warm neutral ground
- **Typography:** Times New Roman / Garamond serif family for headings; clean sans-serif for body
- **No religious references, no AMCAS/AAMC branding, no breathing exercises, no quotes**
- **Chronology required** in all tabs except landing
- **Tab structure:** Narin (landing) · Medicine · Media · Publications

---

## Maintenance

When Narin's activities change:
1. Update this document first
2. Propagate changes to: website (~/projects/narin/portfolio/), LinkedIn, resume
3. Check chronology ordering and date ranges for accuracy
